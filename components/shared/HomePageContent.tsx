...
interface HomePageContentProps {
  /** When true, show the search section (e.g. on admin home to match customer view). When false, hide for authenticated users. */
...
export default function HomePageContent({ forceShowSearch = false, productLinkPrefix = '' }: HomePageContentProps) {
  ...
  const showSearch = forceShowSearch || !isAuthenticated;
    ...
    <main>
      ...
      {productsLoading ? (
        ...
        return carouselProducts.length >= 3 ? (
          <HeroCarousel products={carouselProducts} productLinkPrefix={productLinkPrefix || undefined} />
      ...
      {/* Deal of the Day */}
      {!productsLoading && (
        <DealOfTheDay initialProducts={products} productLinkPrefix={productLinkPrefix || undefined} />
      )}

      {/* Most Viewed Products */}
      {!productsLoading && (
        <MostViewedProducts initialProducts={products} productLinkPrefix={productLinkPrefix || undefined} />
      )}
