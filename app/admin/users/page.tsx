  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#050b2c] via-[#0a1a4a] to-[#050b2c] p-4 sm:p-6 md:p-8"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(255,165,9,0.15),transparent_50%)]"></div>
        <div className="relative z-10">
          <div className="flex flex-col gap-4 sm:gap-6">
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                <motion.div
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className="p-2 sm:p-3 bg-gradient-to-br from-[#ffa509] to-[#ff8c00] rounded-lg sm:rounded-xl shadow-lg w-fit"
                >
                  <FiUsers className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 text-white">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs text-white/70 truncate">Total Users</p>
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 text-white">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs text-white/70 truncate">Admins</p>
                    <p className="text-lg sm:text-xl font-bold">
                      {loadingStats ? (
                        <span className="inline-block w-5 h-5 sm:w-6 sm:h-6 border-2 border-white/30 border-t-white rounded-full animate-spin"></span>
                      ) : (
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 text-white">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs text-white/70 truncate">Customers</p>
                    <p className="text-lg sm:text-xl font-bold">
                      {loadingStats ? (
                        <span className="inline-block w-5 h-5 sm:w-6 sm:h-6 border-2 border-white/30 border-t-white rounded-full animate-spin"></span>
                      ) : (
