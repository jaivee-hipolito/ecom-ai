...
import { FiUpload, FiDownload, FiArrowLeft, FiFileText } from 'react-icons/fi';
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 md:gap-4 mb-2 sm:mb-3 md:mb-4">
                <motion.div
                  ...
                  className="p-2 sm:p-3 md:p-4 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl shadow-cyan-500/50 flex-shrink-0"
                >
                  <FiFileText className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                </motion.div>
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-white/80 text-xs sm:text-sm md:text-lg flex items-center gap-1.5 sm:gap-2">
                    <FiUpload className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#F9629F] flex-shrink-0" />
                    <span className="hidden sm:inline">Import from CSV/Excel or export in various formats</span>
                    <span className="sm:hidden">Import & Export products</span>
                  </p>
                </div>
              </div>
              <motion.div
              ...
              >
                ...
                <span className="text-white/90 font-medium text-xs sm:text-sm">
                  Bulk manage your product catalog efficiently
                </span>
              </motion.div>
            </div>
