        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-1">Secure Password Reset</h3>
                <p className="text-white/70">We'll send you a secure code to reset your password</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/70">The reset code will be sent to your registered email address</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-1">Quick & Easy</h3>
